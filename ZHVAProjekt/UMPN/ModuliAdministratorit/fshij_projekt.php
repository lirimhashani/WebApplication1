...
"SELECT * FROM umpn_projekti ORDER BY ID_Projekti DESC");
?>
...
WHERE
  u.Emri LIKE '%".$term."%' OR u.Adresa LIKE '%".$term."%'"
	...
	while($rreshti = mysqli_fetch_array($sql)) { 		
			...
			echo "<td><a href=\"fshijProjekt.php?ID_Projekti=$rreshti[ID_Projekti]\" onClick=\"return confirm('A jeni te sigurt se deshironi te fshini Projektin?')\" class='button' class='button primary'>Fshijë</a> </td>";			
		}
