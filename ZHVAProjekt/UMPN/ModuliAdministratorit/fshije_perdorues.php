...
"SELECT * FROM umpn_perdoruesi ORDER BY pid DESC");
?>
		...
		<!-- One -->
			<section id="one" class="wrapper style1">
				...
				while($rreshti = mysqli_fetch_array($sql)) { 		
						...
						echo "<td><a href=\"fshijPerdoruesin.php?pid=$rreshti[pid]\" onClick=\"return confirm('A jeni te sigurt se deshironi te fshini perdoruesin?')\" class='button' class='button primary'>Fshije</a>
						</td></tr>";		
					}
