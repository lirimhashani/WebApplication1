...
if(isset($_POST['shtoKontakt'])) {	
	...
	if(empty($Subjekti) || empty($Mesazhi) || empty($Email)) {			
		...
		$result = mysqli_query($lidh, "INSERT INTO umpn_kontakti(Subjekti,Mesazhi,Email) VALUES('$Subjekti','$Mesazhi','$Email')");
		...
		echo "<script>
		 ...
		 echo"<p><b>   Faleminderit qe na kontaktuat. Ju lutem pritni 5 sekonda. <b></p>";
